...
import org.finos.legend.server.pac4j.SerializationHelper;
...
public class MongoDbSessionStore extends HttpSessionStore {
    ...
    private final ObjectMapper serializationHelper;
    ...
    public MongoDbSessionStore(
            ...
            Map<Class<? extends WebContext>, SessionStore> underlyingStores, List<String> extraTrustedPackages,
            String sessionTokenName) {
        this(algorithm, maxSessionLength, userSessions, underlyingStores, new SubjectExecutor(null),
                extraTrustedPackages, sessionTokenName);
    }
    ...
    public MongoDbSessionStore(
        ...
        this.serializationHelper = SerializationHelper.getSerializationHelper(extraTrustedPackages);
    ...
    public Optional<Object> get(WebContext context, String key) {
        ...
        if (res == null) {
            ...
            if (doc != null) {
                ...
                if (serialized != null) {
                    try {
                        res = serializationHelper.readValue(
                                new String(sessionCrypt.fromCryptedString(serialized, token),
                                        java.nio.charset.StandardCharsets.UTF_8), Object.class);
                ...
                token.removeFromContext(this.sessionTokenName, context); // force the token to expire because it doesn't
                                                                         // match any credential in session store.
            }
    ...
    public void set(WebContext context, String key, Object value) {
        if (value instanceof Serializable) {
            ...
            byte[] serialized;
            try {
                serialized = serializationHelper.writeValueAsString(serializable)
    ...
    public ObjectMapper getSerializationHelper() {
